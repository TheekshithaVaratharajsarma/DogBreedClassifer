# -*- coding: utf-8 -*-
"""
Created on Sun Jan 21 01:13:47 2024
...
with open('labels_vgg16.txt', 'w') as file:
    file.write('\n'.join(class_labels))
...
with open('training_history_vgg16.txt', 'w') as file:
...
with open('evaluation_output_vgg16.txt', 'w') as file:
    file.write(f'Test Loss: {test_loss}\n')
    file.write(f'Test Accuracy: {test_acc}\n')

# Save the model to a file in h5 format
model.save('dog_classifier_model_vgg16.h5')
